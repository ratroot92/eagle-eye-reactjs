...
//         let countryIndexMap = {};
//         let list = covid_total_timeline[covid_total_timeline.length - 1].list;
...
//             if (index == undefined) {
//                 index = covid_total_timeline.length - 1;
//             }

//             let data = covid_total_timeline[index];
...
//             let series = lineChart.seriess.push(new am4charts.ColumnSeries());
//             series.dataFields.valueY = name;
...
//                 let di = covid_total_timeline[i].list;
...
//                         (di.confirmed / populations) * 1000000;
//                     polygon.dataItem.dataContext.deathsPC =
//                         (di.deaths / populations) * 1000000;
//                     polygon.dataItem.dataContext.recoveredPC =
//                         (di.recovered / populations) * 1000000;
//                     polygon.dataItem.dataContext.active =
//                         di.confirmed - di.recovered - di.deaths;
//                     polygon.dataItem.dataContext.activePC =
//                         (polygon.dataItem.dataContext.active / populations) * 1000000;

//                     if (populations > 100000) {
...
// function covid_total_timeline(covid_total_timeline: any): string {
...
export default function CoronaDashboard() {
    return <div>CoronaDashboard</div>;
}

  ...
  render() {
    ...
    const authLinks = (
      <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
        <li className="nav-item">
          <Link to="/admin" className={`nav-link text-full-black`}>
            Admin
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/" className={`nav-link text-full-black`}>
            Twitter Trends
          </Link>
        </li>
        <li className="nav-item">
          <Link to="/twitter-crawler" className={`nav-link text-full-black`}>
            Twitter Crawler
          </Link>
        </li>
        <li className="nav-item">
          <Link
            to="/twitter-rapid-search"
            className={`nav-link text-full-black`}
          >
            Rapid Search
          </Link>
        </li>
        ...
        <li className="nav-item">
          <button
            ...
            className={`nav-link text-full-black btn btn-sm btn-warning btn-sm text-light`}
          >
            Logout
          </button>
        </li>
    ...
    const guestLinks = (
      <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
        {/* <li className="nav-item">
          <Link  to="/register" className={`nav-link text-full-black`}>
            Register
          </Link>
        </li> */}
        <li className="nav-item">
          <Link to="/login" className={`nav-link text-full-black`}>
            Login
          </Link>
        </li>
      </ul>
